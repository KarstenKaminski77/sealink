...
mysql_select_db($database_seavest, $seavest);
$query_Recordset3 = "SELECT tbl_sites.Name AS Name_1, tbl_jc.QuoteNo, tbl_jc.CompanyId, tbl_jc.SiteId, tbl_jc.Date, tbl_jc.JobDescription, tbl_jc.JobNo, tbl_jc.JobId, tbl_companies.Name FROM ((tbl_jc LEFT JOIN tbl_companies ON tbl_companies.Id=tbl_jc.CompanyId) LEFT JOIN tbl_sites ON tbl_sites.Id=tbl_jc.SiteId) WHERE Status = '5' $where GROUP BY tbl_jc.JobId";
    ...
    <td valign="top"><table width="750" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td colspan="4">
			  <table width="700" border="0" align="center" cellpadding="3" cellspacing="1" class="combo">
                <tr class="td-header">
                  ...
                  <td width="200" align="left"><strong>Date</strong></td>
...
<tr class="<?php echo ($ac_sw1++%2==0)?"odd":"even"; ?>" onMouseOver="this.oldClassName = this.className; this.className='list-over';" onMouseOut="this.className = this.oldClassName;">
                          <td width="100"><a href="jc_calc.php?menu=<?php echo $_GET['menu']; ?>&Id=<?php echo $row_Recordset3['JobId']; ?>&job" class="menu" ONMOUSEOVER="popup('<?php echo $row_Recordset3['JobDescription']; ?>','#CEE1F7')"; ONMOUSEOUT="kill()"><?php echo $row_Recordset3['JobNo']; ?></a></td>
                          ...
                          <td width="40" align="center" style="cursor: hand" onClick="MM_openBrWindow('reason.php?Id=<?php echo $row_Recordset3['JobId']; ?>','','scrollbars=yes,width=400,height=400')"><img title="Reason" src="images/icons/btn-reason.png" width="25" height="25"></td>
                          </tr>
                        <?php } 
