...
if(!empty($_POST['date'])){
	...
	$where = "tbl_management_report_details.Date = '". $_POST['date'] ."' AND ";
}
...
LEFT JOIN tbl_management_report_priorities ON tbl_management_report_priorities.Id=tbl_management_report_details.Priority)
LEFT JOIN tbl_users ON tbl_users.Id=tbl_management_reports.ManagerId)
LEFT JOIN tbl_users AS tbl_users_0 ON tbl_users_0.Id=tbl_management_reports.CoordinatorId) WHERE $where tbl_management_report_details.Weekend = '0' ORDER BY tbl_management_report_details.Date DESC")or die(mysqli_error($con));
...
include('../menu.php'); ?>
  ...
  <tr class="<?php echo ($ac_sw1++%2==0)?"odd":"even"; ?>" onMouseOver="this.oldClassName = this.className; this.className='list-over';" onMouseOut="this.className = this.oldClassName;">
		...
		class="highslide">
              ...
              <td width="25" align="center">
              <a href="view-reports.php?Id=<?php echo $_GET['Id']; ?>&Mail=<?php echo $row_list['Id']; ?>" class="menu">
