...
<body>
  ...
  <div class="td-bread">
    <ul class="breadcrumb">
      ...
      <li><a href="#">(<?= awaiting_estimate($con, false); ?>)</a></li>
      <li></li>
    </ul>
  </div>
  <!-- End Breadcrumbs -->
              ...
              <tr class="<?php echo ($ac_sw1++ % 2 == 0) ? " odd " : "even "; ?>" onMouseOver="this.oldClassName = this.className; this.className='over';" onMouseOut="this.className = this.oldClassName;">
                ...
                <td width="20" align="center">
                  <?php if ($row_Recordset3['JobcardPDF'] != NULL) { ?>
                    <a href="create-quote.php?Id=<?php echo $row_Recordset3['JobId']; ?>&JobNo=<?php echo $row_Recordset3['JobNo']; ?>" target="_blank" class="icon-qs fancybox" title="Create Quote"></a>
                  <?php } ?>
                </td>
                <td width="20" align="center">
                  <?php
                  ...
                  if ($numrows >= 1) { ?>
                    ...
                    <a href="../jc-pdf/<?php echo $row_Recordset3['JobcardPDF']; ?>" class="icon-pdf fancybox"></a>
