...
if(isset($_GET['AddLabour']) || isset($_GET['AddMaterial']) || isset($_GET['AddTransport']) || isset($_GET['Delete'])){
	...
	if(isset($_GET['AddLabour'])){
		...
		header('Location: jc-calc-new.php?Id='. $_GET['Id'] .'#Labour');
	...
	if(isset($_GET['AddMaterial'])){
		...
		dbInsert('tbl_jc', $form_data, $con);
		header('Location: jc-calc-new.php?Id='. $_GET['Id'] .'#Material');
	...
	if(isset($_GET['AddTransport'])){
		...
		header('Location: jc-calc-new.php?Id='. $_GET['Id'] .'#Transport');
	...
	if(isset($_GET['Delete'])){
		...
		header('Location: jc-calc-new.php?Id='. $_GET['Id'] .'#Delete');
...
if(isset($_POST['update']) || isset($_POST['in-progress']) || isset($_POST['awaiting-pwk']) || isset($_POST['costing']) || isset($_POST['pre-work-po']) || isset($_POST['invoice'])){
	...
	if(isset($_POST['in-progress'])){
		...
		if(empty($_POST['service'])){
			...
			header('Location: jc-calc-new.php?Id='. $_GET['Id'] .'&Service');
	...
	if(isset($_POST['costing']) || isset($_POST['request-pre-po'])){
		...
		if(empty($_POST['service']) || empty($_POST['feedback']) || empty($_POST['reference'])) {
            ...
            header('Location: jc-calc-new.php?Id='.$jobid);
	...
	header('Location: jc-calc-new.php?Id='. $_GET['Id'] .'#Btm');
}

if(($row_jc['InvoiceNo'] == 0) && ($row_jc['Status'] != 1)) {


    mysqli_query($con, "INSERT INTO tbl_invoice_numbers (JobNo) VALUES ('1')") or die(mysqli_error($con));

    $query = mysqli_query($con, "SELECT * FROM tbl_invoice_numbers ORDER BY Id DESC LIMIT 1") or die(mysqli_error($con));
    $row = mysqli_fetch_array($query);
...
FROM
    (
        (
            tbl_jc LEFT JOIN tbl_sites ON tbl_sites.Id = tbl_jc.SiteId
      ...
      <div id="main-wrapper">
        ...
        <!-- End Warning Messages -->
          ...
          <div id="list-border">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
              ...
              <tr>
                ...
                <td colspan="2" class="td-right"><div class="cloak"><input name="pdf" type="file" class="pdf-file-input" id="pdf" /></div></td>
              </tr>
            </table>
          </div>
          ...
          <div id="list-border" style="margin-top:15px">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                <td rowspan="2" width="137"><div id="clockdiv">
                  <div style="display:none"> <span class="days">0</span>
                  ...
                  <?php if($row_jc['Date2'] > date('Y-m-d H:i:s')){ ?>
                  <?php
                          
                          date_default_timezone_set("Africa/Johannesburg");
                          $dt2 = strtotime($row_jc['Date2']);
                          $dt1 = strtotime($row_jc['Date1']);
                ...
                <td class="td-header">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td>&nbsp;</td>
                      <td align="right">
                        <a href="jc-calc-new.php?Id=<?php echo $_GET['Id']; ?>&costing">
          ...
          <div id="list-border" style="margin-top:15px">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                <td colspan="4" class="td-header">Proactive Risk Assessment</td>
              </tr>
              <tr>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
              ...
              <tr>
                <td class="td-sub-sub-sub-header"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><?php echo $totalRows_job_history .' Photos'; ?></td>
                        ...
                        <table border="0" cellpadding="2" cellspacing="3">
                          <tr>
                            <?php
                              ...
                              ?>
                            <td>
                              <a href="../images/history/<?php echo $row_job_history['Photo']; ?>" class="look_inside icon-img" onClick="return hs.expand(this, {captionId: 'caption1'})"></a></td>
                            <?php
                              $row_job_history = mysqli_fetch_assoc($job_history);
                              if (!isset($nested_job_history)) {
                                $nested_job_history= 1;
                              }
                              if (isset($row_job_history) && is_array($row_job_history) && $nested_job_history++ % 24==0) {
                                echo "</tr><tr>";
                              }
          ...
          <div id="list-border" style="margin-top:15px">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                ...
                <td colspan="5" class="td-sub-header">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="15" align="right"><a href="jc-calc-new.php?Id=<?php echo $_GET['Id']; ?>&AddLabour" class="add-row-jc"></a></td>
                    </tr>
                </table></td>
              </tr>
              ...
              <tr>
                <td class="td-right">
                  <textarea name="labour[]" wrap="hard" class="tarea-100" id="labour"><?php if($row['Description'] == NULL){ echo 'Conducted risk assessment & completed necessary safety documents'; } else { echo $row['Description']; } ?></textarea>
                </td>
                ...
                <td class="td-right">
                  <a href="jc-calc-new.php?Id=<?php echo $_GET['Id']; ?>&Delete=<?php echo $row['Id']; ?>" class="remove"></a>
                ...
                <td colspan="5" class="td-sub-header">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="15"><a href="jc-calc-new.php?Id=<?php echo $_GET['Id']; ?>&AddMaterial" class="add-row-jc"></a></td>
                    </tr>
                </table></td>
              </tr>
              <?php
                ...
                <td colspan="5" class="td-sub-header">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="15"><a href="jc-calc-new.php?Id=<?php echo $_GET['Id']; ?>&AddTransport" class="add-row-jc"></a></td>
                    </tr>
                </table></td>
              </tr>
              <?php
          ...
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr>
              <td>
                <?php if($row_jc['Status'] == 1 || $row_jc['Status'] == 5){ ?>
