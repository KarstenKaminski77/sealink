...
include('menu.php'); ?>
    ...
    <td valign="top"><table width="861" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="750" align="center"><table class="combo">
            <tr>
              <td class="combo"><div style="border:solid 1px #A6CAF0;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td colspan="2" valign="top"><div id="add_row" style="margin-top:4px; margin-left:4px; margin-right:4px;">
					  <table width="100%" border="0" cellpadding="3" cellspacing="0" class="combo_bold">
                        <tr>
                          <td width="59%" align="right" valign="middle"><form name="form2" method="post" action="revive.php?Id=<?php echo $_GET['Id']; ?>">
                              <input name="Submit2" type="submit" class="tarea2" value="Edit">
                          </form></td>
                          <td width="25%" align="right" valign="middle"><form action="" method="post" name="form3" onSubmit="MM_openBrWindow('inv_mail_ini.php?Id=<?php echo $_GET['Id']; ?>','','width=400,height=200')">
                              <input name="mail" type="text" class="tarea2" id="mail" style="cursor:text">
                            &nbsp;
                            <input name="Submit3" type="submit" class="tarea2" value="Email">
                          </form></td>
                          <td width="7%" align="right" valign="middle"><form action="inv_print.php?Id=<?php echo $_GET['Id']; ?>" method="post" name="form1" target="_blank">
                              <input name="Submit" type="submit" class="tarea2" value="Print">
                          </form></td>
                          <td width="9%" align="right" valign="middle"><form name="form4" method="post" action="inv_paid.php?Id=<?php echo $_GET['Id']; ?>">
...
<?php if($row_Recordset3['CompanyId'] == 1){ ?>
					<table width="100%" border="1" cellpadding="0" cellspacing="4" bordercolor="#FFFFFF">
                      ...
                      <tr>
                        <td width="33%" bordercolor="#FFFFFF" class="combo2">&nbsp;<?php echo $row_Recordset3['JobNo']; ?></td>
...
?>
                        <table width="100%" border="0" cellpadding="0" cellspacing="1">
                          <tr>
                            ...
                            <td width="50" align="center" valign="bottom" class="combo2">
							<?php 
							if($row['Qty'] != 0){
							echo $row['Qty']; 
							}
							?></td>
                            <td width="100" align="center" valign="bottom" class="combo2">
							<?php 
							if($row['Price'] != 0){
							echo $row['Price']; 
							}
							?></td>
                            <td width="50" align="center" valign="bottom" class="combo">
							<?php 
							if($row['Total1'] != 0){
							echo 'R'. $row['Total1']; 
							}
...
<div style="border-top:solid 1px #A6CAF0; margin-left:5px; margin-right:5px"><br>
                </div>                        &nbsp; <span class="combo_bold">Material<br>
                <br>
                        </span>
                        <?php
...
?>
                        <table width="100%" border="0" cellpadding="0" cellspacing="1">
                          <tr>
                            ...
                            <td width="100" align="center" valign="bottom" class="combo2">R<?php echo $row['Price']; ?></td>
...
<div style="border-top:solid 1px #A6CAF0; margin-left:5px; margin-right:5px"><br>
                        ...
                        &nbsp; <span class="combo_bold">Transport<br>
                        <br>
                        </span>
                        <?php
...
?>
                        <table width="100%" border="0" cellpadding="0" cellspacing="1">
                          <tr>
                            <td width="450" class="combo2">&nbsp;&nbsp; <?php echo $row['Description']; ?></td>
                            <td width="50" align="center" valign="bottom" class="combo2">Km</td>
                            <td width="50" align="center" valign="bottom" class="combo2"><?php echo $row['Qty']; ?></td>
                            <td width="100" align="center" valign="bottom" class="combo2">R<?php echo $row_Recordset8['Rate']; ?></td>
                            <td width="50" align="center" valign="bottom" class="combo">R<?php echo $row['Total1']; ?>&nbsp;&nbsp; </td>
                          </tr>
                        </table>
                        <?php } // close loop ?>
...
<div style="border-top:solid 1px #A6CAF0; margin-left:5px; margin-right:5px"><br>
                </div>                        <table border="0" align="right" cellpadding="0" cellspacing="3" class="combo2">
                      <tr>
