...
if(isset($_POST['submit'])){
	...
	mysql_query("INSERT INTO tbl_scaffold (Date, Technician, Item, Qty, Comments) VALUES ('$date','$technician','$item','$qty','$comments')")or die(mysql_error());
...
mysql_select_db($database_seavest, $seavest);
$query_Recordset2 = "SELECT * FROM tbl_scaffold $string ORDER BY Date ASC";
      ...
      <tr>
        <td><p><br>
          ...
          <div style="padding-left:30px">
            <form name="form2" method="post" action="scaffold-register.php">
              <table border="0" cellpadding="2" cellspacing="3" class="combo">
                <tr>
                  <td>Scaffold Inspector</td>
...
?>
            ...
            <table border="0" cellpadding="3" cellspacing="1" class="combo">
              <tr>
                <td colspan="5"><form name="form3" method="post" action="scaffold-register.php">
                  <table border="0" cellpadding="2" cellspacing="3" class="combo">
                    <tr>
                      <td><strong>Scaffold Inspector</strong></td>
                      <td><strong>Scaffold component</strong></td>
...
?>
              ...
              <tr class="td-header">
                ...
                <td width="200"><strong>Scaffold Inspector</strong></td>
                <td width="200">Scaffold component</td>
                <td width="100">Qty</td>
...
<tr class="<?php echo ($ac_sw1++%2==0)?"odd":"even"; ?>" onMouseOver="this.oldClassName = this.className; this.className='list-over';" onMouseOut="this.className = this.oldClassName;">
                  ...
                  <td width="200"><?php echo $row_Recordset2['Item']; ?></td>
