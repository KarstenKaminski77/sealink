...
if (isset($_GET['DeleteRow'])) {
    ...
    header('Location: inv-calc.php?Id=' . $_GET['Id'] . '#Labour');
}
...
if (isset($_GET['DeleteTransport'])) {
    ...
    header('Location: inv-calc.php?Id=' . $_GET['Id'] . '#Transport');
}
...
if (isset($_GET['AddLabour'])) {
    ...
    mysqli_query($con, "INSERT INTO tbl_jc (InvoiceNo,JobId,BatchNo,Labour,Unit) VALUES ('$invoiceno','$jobid','$batch','1','hours')") or die(mysqli_error($con));
...
if (isset($_GET['AddMaterial'])) {
    ...
    mysqli_query($con, "INSERT INTO tbl_jc (InvoiceNo,JobId,BatchNo,Material) VALUES ('$invoiceno','$jobid','$batch','1')") or die(mysqli_error($con));

    header('Location: inv-calc.php?Id=' . $_GET['Id'] . '#Material');
}
...
if (isset($_GET['AddTransport'])) {
    ...
    mysqli_query($con, "INSERT INTO tbl_travel (JobId,BatchNo) VALUES ('$jobid','$batch')") or die(mysqli_error($con));

    header('Location: inv-calc.php?Id=' . $_GET['Id'] . '#Transport');
}

// Add comment row
if (isset($_GET['comment_row']) && $_POST['comment_row'] >= 1) {
    ...
    for ($i = 0; $i < $rows; $i++) {
        ...
        mysqli_query($con, "INSERT INTO tbl_jc (InvoiceNo,JobId,Comment,BatchNo) VALUES ('$invoiceno','$jobid','1','$batch')") or die(mysqli_error($con));
    }
}
...
if (isset($_GET['update'])) {
    ...
    for ($i = 0; $i < $numrows; $i++) {
        ...
        if ($unit == 'hours') {
            ...
            mysqli_query($con, "UPDATE tbl_jc SET  Description = '".mysqli_real_escape_string($con, $labour)."', Unit = '$unit', Qty = '$qty', Price = '$new_price', Total1 = '$total', LabourType = '$labour_name' WHERE Id = '$id'") or die(mysqli_error($con));
        }

        if ($unit == 'km') {

            mysqli_query($con, "UPDATE tbl_jc SET  Description = '".mysqli_real_escape_string($con, $labour)."', Unit = '$unit', Qty = '$qty_fuel', Price = '$new_price', Total1 = '$total_fuel', LabourType = '$labour_name' WHERE Id = '$id'") or die(mysqli_error($con));
        }
    }
    ...
    for ($i = 0; $i < $numrows; $i++) {
        ...
        $total = $qty * $price;
        mysqli_query($con, "UPDATE tbl_jc SET  Description = '".mysqli_real_escape_string($con, $material)."', Unit = '$unit', Qty = '$qty', Price = '$price', Total1 = '$total' WHERE Id = '$id'") or die(mysqli_error($con));
    }
    ...
    for ($i = 0; $i < $numrows; $i++) {
        ...
        mysqli_query($con, "UPDATE tbl_travel SET  JobNo = '$jobno', Description = '".mysqli_real_escape_string($con, $transport)."', Unit = '$unit', Qty = '$qty', Price = '$price', Total1 = '$total', TransportComment = '".mysqli_real_escape_string($con, $comment)."', TravelTime = '$travel_time', TravelTimeRate = '$travel_time_rate', TotalPragma = '$total_pragma' WHERE Id = '$id'") or die(mysqli_error($con));
    }
...
$query_transport = mysqli_query($con, "SELECT SUM(Total1) AS Total FROM tbl_travel WHERE JobId = '$jobid'") or die(mysqli_error($con));
...
if ($row_Recordset5['BatchNo'] >= 1) {

    $total_batch = 0;

    $query_batch = mysqli_query($con, "SELECT Total2 FROM tbl_jc WHERE BatchNo = '" . $row_Recordset5['BatchNo'] . "' GROUP BY JobId") or die(mysqli_error($con));
    while ($row_batch = mysqli_fetch_array($query_batch)) {

        $total_batch += $row_batch['Total2'];
    }

    mysqli_query($con, "UPDATE tbl_batch_inv SET Total = '$total_batch' WHERE Id = '" . $row_Recordset5['BatchNo'] . "'") or die(mysqli_error($con));
}
// End Update Bath Invoice Total
                    ...
                    <div id="main-wrapper" style="margin-bottom:105px;width: calc(100% - 40px)">
                        ...
                        <div id="list-border" style="margin-bottom:15px">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                                <tr>
                                    <td colspan="6" class="td-header">Invoice</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="td-right">
                                        ...
                                        ?>
                                        <input name="inv_date" class="tarea-100" id="inv_date" value="<?php echo $date2; ?>">
                                ...
                                <tr>
                                    ...
                                    <td class="td-right">
                                        <?php echo char_limit($row_Recordset5['CompanyAddress'], 30); ?></td>
                                    <td class="td-left">Address</td>
                                    <td class="td-right"><?php echo char_limit($row_Recordset5['Address'], 30); ?></td>
                                    <td class="td-left">Invoice No.</td>
...
' .
                                ...
                                ?>
                                        <tr>
                                            <td class="td-right">
                                                <select name="day[] " class="tarea-navy" id="day[] ">
                                                    <option value="1 " selected <?php if (!(strcmp(1, $day))) {
                                                                                    echo "selected=\"selected\" ";
                                                                                } ?>>1
                                                    </option>
                                                    <option value="2 " <?php if (!(strcmp(2, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>2
                                                    </option>
                                                    <option value="3 " <?php if (!(strcmp(3, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>3
                                                    </option>
                                                    <option value="4 " <?php if (!(strcmp(4, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>4
                                                    </option>
                                                    <option value="5 " <?php if (!(strcmp(5, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>5
                                                    </option>
                                                    <option value="6 " <?php if (!(strcmp(6, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>6
                                                    </option>
                                                    <option value="7 " <?php if (!(strcmp(7, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>7
                                                    </option>
                                                    <option value="8 " <?php if (!(strcmp(8, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>8
                                                    </option>
                                                    <option value="9 " <?php if (!(strcmp(9, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>9
                                                    </option>
                                                    <option value="10 " <?php if (!(strcmp(10, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>10
                                                    </option>
                                                    <option value="11 " <?php if (!(strcmp(11, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>11
                                                    </option>
                                                    <option value="12 " <?php if (!(strcmp(12, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>12
                                                    </option>
                                                    <option value="13 " <?php if (!(strcmp(13, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>13
                                                    </option>
                                                    <option value="14 " <?php if (!(strcmp(14, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>14
                                                    </option>
                                                    <option value="15 " <?php if (!(strcmp(15, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>15
                                                    </option>
                                                    <option value="16 " <?php if (!(strcmp(16, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>16
                                                    </option>
                                                    <option value="17 " <?php if (!(strcmp(17, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>17
                                                    </option>
                                                    <option value="18 " <?php if (!(strcmp(18, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>18
                                                    </option>
                                                    <option value="19 " <?php if (!(strcmp(19, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>19
                                                    </option>
                                                    <option value="20 " <?php if (!(strcmp(20, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>20
                                                    </option>
                                                    <option value="21 " <?php if (!(strcmp(21, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>21
                                                    </option>
                                                    <option value="22 " <?php if (!(strcmp(22, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>22
                                                    </option>
                                                    <option value="23 " <?php if (!(strcmp(23, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>23
                                                    </option>
                                                    <option value="24 " <?php if (!(strcmp(24, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>24
                                                    </option>
                                                    <option value="25 " <?php if (!(strcmp(25, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>25
                                                    </option>
                                                    <option value="26 " <?php if (!(strcmp(26, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>26
                                                    </option>
                                                    <option value="27 " <?php if (!(strcmp(27, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>27
                                                    </option>
                                                    <option value="28 " <?php if (!(strcmp(28, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>28
                                                    </option>
                                                    <option value="29 " <?php if (!(strcmp(29, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>29
                                                    </option>
                                                    <option value="30 " <?php if (!(strcmp(30, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>30
                                                    </option>
                                                    <option value="31 " <?php if (!(strcmp(31, $day))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>31
                                                    </option>
                                                </select>
                                            ...
                                            <td class="td-right">
                                                <select name="month[] " class="tarea-navy" id="month[] ">
                                                    <option value="January " <?php if (!(strcmp("January ", $month))) {
                                                                                    echo "selected=\"selected\" ";
                                                                                } ?>>
                                                        January</option>
                                                    <option value="February " <?php if (!(strcmp("February ", $month))) {
                                                                                    echo "selected=\"selected\" ";
                                                                                } ?>>
                                                        February</option>
                                                    <option value="March " <?php if (!(strcmp("March ", $month))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        March</option>
                                                    <option value="April " <?php if (!(strcmp("April ", $month))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        April</option>
                                                    <option value="May " <?php if (!(strcmp("May ", $month))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        May</option>
                                                    <option value="June " <?php if (!(strcmp("June ", $month))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        June</option>
                                                    <option value="July " <?php if (!(strcmp("July ", $month))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        July</option>
                                                    <option value="August " <?php if (!(strcmp("August ", $month))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        August</option>
                                                    <option value="September " <?php if (!(strcmp("September ", $month))) {
                                                                                    echo "selected=\"selected\" ";
                                                                                } ?>>
                                                        September</option>
                                                    <option value="October " <?php if (!(strcmp("October ", $month))) {
                                                                                    echo "selected=\"selected\" ";
                                                                                } ?>>
                                                        October</option>
                                                    <option value="November " <?php if (!(strcmp("November ", $month))) {
                                                                                    echo "selected=\"selected\" ";
                                                                                } ?>>
                                                        November</option>
                                                    <option value="December " <?php if (!(strcmp("December ", $month))) {
                                                                                    echo "selected=\"selected\" ";
                                                                                } ?>>
                                                        December</option>
                                                </select>
                                            ...
                                            <td class="td-right">
                                                <select name="year[] " class="tarea-navy" id="year[] ">
                                                    <option value="2009 " selected <?php if (!(strcmp(2009, $year))) {
                                                                                        echo "selected=\"selected\" ";
                                                                                    } ?>>
                                                        2009</option>
                                                    <option value="2010 " <?php if (!(strcmp(2010, $year))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        2010</option>
                                                    <option value="2011 " <?php if (!(strcmp(2011, $year))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        2011</option>
                                                    <option value="2012 " <?php if (!(strcmp(2012, $year))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        2012</option>
                                                    <option value="2013 " <?php if (!(strcmp(2013, $year))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        2013</option>
                                                    <option value="2014 " <?php if (!(strcmp(2014, $year))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        2014</option>
                                                    <option value="2015 " <?php if (!(strcmp(2015, $year))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        2015</option>
                                                    <option value="2017 " <?php if (!(strcmp(2017, $year))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        2016</option>
                                                    <option value="2018 " <?php if (!(strcmp(2018, $year))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        2018</option>
                                                    <option value="2019 " <?php if (!(strcmp(2019, $year))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        2019</option>
                                                    <option value="2020 " <?php if (!(strcmp(2020, $year))) {
                                                                                echo "selected=\"selected\" ";
                                                                            } ?>>
                                                        2020</option>
                                                </select>
                                            ...
                                            <td class="td-right">
                                                <select name="hour[] " class="tarea-navy" id="hour[] ">
                                                    <option value="1 " selected <?php if (!(strcmp(1, $hour))) {
                                                                                    echo "selected=\"selected\" ";
                                                                                } ?>>1
                                                    </option>
                                                    <option value="2 " <?php if (!(strcmp(2, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>2
                                                    </option>
                                                    <option value="3 " <?php if (!(strcmp(3, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>3
                                                    </option>
                                                    <option value="4 " <?php if (!(strcmp(4, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>4
                                                    </option>
                                                    <option value="5 " <?php if (!(strcmp(5, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>5
                                                    </option>
                                                    <option value="6 " <?php if (!(strcmp(6, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>6
                                                    </option>
                                                    <option value="7 " <?php if (!(strcmp(7, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>7
                                                    </option>
                                                    <option value="8 " <?php if (!(strcmp(8, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>8
                                                    </option>
                                                    <option value="9 " <?php if (!(strcmp(9, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>9
                                                    </option>
                                                    <option value="10 " <?php if (!(strcmp(10, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>10
                                                    </option>
                                                    <option value="11 " <?php if (!(strcmp(11, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>11
                                                    </option>
                                                    <option value="12 " <?php if (!(strcmp(12, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>12
                                                    </option>
                                                    <option value="13 " <?php if (!(strcmp(13, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>13
                                                    </option>
                                                    <option value="14 " <?php if (!(strcmp(14, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>14
                                                    </option>
                                                    <option value="15 " <?php if (!(strcmp(15, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>15
                                                    </option>
                                                    <option value="16 " <?php if (!(strcmp(16, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>16
                                                    </option>
                                                    <option value="17 " <?php if (!(strcmp(17, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>17
                                                    </option>
                                                    <option value="18 " <?php if (!(strcmp(18, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>18
                                                    </option>
                                                    <option value="19 " <?php if (!(strcmp(19, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>19
                                                    </option>
                                                    <option value="20 " <?php if (!(strcmp(20, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>20
                                                    </option>
                                                    <option value="21 " <?php if (!(strcmp(21, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>21
                                                    </option>
                                                    <option value="22 " <?php if (!(strcmp(22, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>22
                                                    </option>
                                                    <option value="23 " <?php if (!(strcmp(23, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>23
                                                    </option>
                                                    <option value="24 " <?php if (!(strcmp(24, $hour))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>24
                                                    </option>
                                                </select>
                                            ...
                                            <td class="td-right">
                                                <select name="minute[] " class="tarea-navy" id="minute[] ">
                                                    <option value="00 " selected <?php if (!(strcmp(00, $minute))) {
                                                                                        echo "selected=\"selected\" ";
                                                                                    } ?>>00
                                                    </option>
                                                    <option value="05 " <?php if (!(strcmp(05, $minute))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>05
                                                    </option>
                                                    <option value="10 " <?php if (!(strcmp(10, $minute))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>10
                                                    </option>
                                                    <option value="15 " <?php if (!(strcmp(15, $minute))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>15
                                                    </option>
                                                    <option value="20 " <?php if (!(strcmp(20, $minute))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>20
                                                    </option>
                                                    <option value="25 " <?php if (!(strcmp(25, $minute))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>25
                                                    </option>
                                                    <option value="30 " <?php if (!(strcmp(30, $minute))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>30
                                                    </option>
                                                    <option value="35 " <?php if (!(strcmp(35, $minute))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>35
                                                    </option>
                                                    <option value="40 " <?php if (!(strcmp(40, $minute))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>40
                                                    </option>
                                                    <option value="45 " <?php if (!(strcmp(45, $minute))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>45
                                                    </option>
                                                    <option value="50 " <?php if (!(strcmp(50, $minute))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>50
                                                    </option>
                                                    <option value="55 " <?php if (!(strcmp(55, $minute))) {
                                                                            echo "selected=\"selected\" ";
                                                                        } ?>>55
                                                    </option>
                                                </select>
                                        ...
                                        <tr>
                                            <td colspan="8" class="td-right">
                                                ...
                                                <textarea name="comment[]" rows="4" class="tarea-100" id="textarea" type="text" value="<?php echo $row['CommentText']; ?>"></textarea>
                                            </td>
                                        </tr>
                                    <?php
                                    }
                                    ...
                                    <tr>
                                        <td class="td-right">
                                            <select name="day" class="tarea-navy" id="day">
                                                <option value="1" <?php if (!(strcmp(1, $day))) {
                                                                        echo "selected=\"selected\"";
                                                                    } ?>>1
                                                </option>
                                                <option value="2" <?php if (!(strcmp(2, $day))) {
                                        ...
                                        <td class="td-right">
                                            <select name="year" class="tarea-navy" id="year">
                                                <option value="2009" selected="selected" <?php if (!(strcmp(2009, $year))) {
                                                                                                echo "selected=\"selected\"";
                                                                                            } ?>>
                                                    2009</option>
                                                <option value="2010" <?php if (!(strcmp(2010, $year))) {
                                        ...
                                        <td class="td-right">
                                            <select name="hour" class="tarea-navy" id="hour">
                                                <option value="1" selected="selected" <?php if (!(strcmp(1, $hour))) {
                                                                                            echo "selected=\"selected\"";
                                                                                        } ?>>1
                                                </option>
                                                <option value="2" <?php if (!(strcmp(2, $hour))) {
                                        ...
                                        <td class="td-right">
                                            <select name="minute" class="tarea-navy" id="minute">
                                                <option value="00" selected="selected" <?php if (!(strcmp(00, $minute))) {
                                                                                            echo "selected=\"selected\"";
                                                                                        } ?>>00
                                                </option>
                                                <option value="05" <?php if (!(strcmp(05, $minute))) {
                                        ...
                                        <td class="td-right">
                                            <select name="tech" class="tarea-100" id="tech">
                                                <option value="" <?php if (!(strcmp("", $row['FeedBackTech']))) {
                                                                        echo "selected=\"selected\"";
                                                                    } ?>>
                                                    Select one...</option>
                                                <?php do { ?>
                                                    <option value="<?php echo $row_Recordset100['Id'] ?>" <?php if (!(strcmp($row_Recordset100['Id'], $row['FeedBackTech']))) {
                                                                                                                echo "selected=\"selected\"";
                                                                                                            } ?>>
                                    ...
                                    <tr>
                                        <td colspan="8" class="td-right">
                                            <textarea name="comment" rows="8" class="tarea-100" id="comment" type="text"></textarea>
                                        </td>
                                    </tr>
                            </table>
                        </div>
                                ...
                                <tr>
                                    <td class="td-right">
                                        <select name="fb_day" class="tarea-navy" id="fb_day">
                                            <option value="1" selected="selected" <?php if (!(strcmp(1, $day))) {
                                                                                        echo "selected=\"selected\"";
                                                                                    } ?>>1
                                            </option>
                                            <option value="2" <?php if (!(strcmp(2, $day))) {
                        ...
                        <div id="list-border" style="margin-bottom:15px">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                                <tr>
                                    <td colspan="8" class="td-header">Gallery
                                        <?php if ($totalRows_job_history >= 1) {
                                            echo ' | ' . $totalRows_job_history . ' Photos';
                                        } ?>
                                    </td>
                                </tr>
                                <tr>
                                                            ...
                                                            ?>
                                                                <td>
                                                                    <a href="../images/history/<?php echo $row_job_history['Photo']; ?>" class="look_inside" onclick="return hs.expand(this, {captionId: 'caption1'})">
                                                                        <img src="../images/icons/icon-image.png" alt="" width="25" height="24" border="0"> </a>
                                                                </td>
                                                            <?php
                                                                $row_job_history = mysqli_fetch_assoc($job_history);
                                                                ...
                                                                if (isset($row_job_history) && is_array($row_job_history) && $nested_job_history++ % 27 == 0) {
                                                                    echo "
</tr>
<tr>
";
                        ...
                        <div id="list-border" style="margin-bottom:15px; width:910px; float:right">
                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                <tr>
                                    ...
                                    <td width="140" align="right" class="td-header-right">
                                        <div style="padding-right:10px">Unit Price</div>
                                    </td>
                                    <td width="30" align="center" class="td-header-right">X</td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="td-sub-sub-header" style="padding-right:0">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td> Labour <a name="Labour" id="Labour"></a> <a name="Btm" id="Btm"></a></td>
                                                <td width="35" align="center"><a href="inv-calc.php?Id=<?php echo $_GET['Id']; ?>&AddLabour" class="add-row-inv"></a></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td align="center" valign="top" class="td-right-jc">
                                            <?php if ($unit == 'hours') { ?>
                                                <select name="price_l[]" class="tarea-100" id="price_l[]" dir="rtl">
                                                    ...
                                                    do {
                                                    ?>
                                                        <option value="<?php echo $row_Recordset101['Rate'] . '_' . $row_Recordset101['Name_1']; ?>" <?php if ($row_Recordset101['Name_1'] == $labour_type) {
                                                                                                                                                            echo "selected=\"selected\"";
                                                                                                                                                        } ?>>
                                                            <?php echo $row_Recordset101['Name_1']; ?> </option>
                                                    <?php
                                        ...
                                        <td align="center" valign="top" class="td-right-jc" style="padding:0">
                                            <a href="inv-calc.php?Id=<?php echo $_GET['Id']; ?>&DeleteRow=<?php echo $row['Id']; ?>" class="remove"></a>
                                    ...
                                    <td colspan="5" class="td-sub-sub-header" style="padding-right:0">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="35"><a href="inv-calc.php?Id=<?php echo $_GET['Id']; ?>&AddMaterial" class="add-row-inv"></a></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td colspan="5" class="td-sub-sub-header" style="padding-right:0">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="35"><a href="inv-calc.php?Id=<?php echo $_GET['Id']; ?>&AddTransport" class="add-row-inv"></a></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="td-right">
                                            <a href="inv-calc.php?Id=<?php echo $_GET['Id']; ?>&DeleteTransport=<?php echo $row['Id']; ?>" class="remove"></a>
                        ...
                        <!-- Footer -->
                        <div id="footer-sticky" style="float:right">
                                    ...
                                    <td>
                                        ...
                                        <?php if ($row_Recordset5['Status'] == 7) { ?>
                                            ...
                                            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="3">
                                                <tr>
                                                    <td align="left" valign="top"></span> <a alt="" class="btn-new" onclick="MM_openBrWindow('../reject.php?Id=<?php echo $_GET['Id']; ?>','','width=600,height=200')">Reject</a>
                                                    </td>
