            ...
            <tr>
                <td valign="bottom" class="combo_bold">
                    <form name="form1" method="post" action="">
                        <select name="menu1" class="select-5" onchange="MM_jumpMenu('parent',this,0)">
                            ...
                            <option value="processing-new.php?all">All</option>
                            <option value="processing-new.php?area">Area</option>
                            <option value="processing-new.php?jcn">Job Card Number</option>
                            <option value="processing-new.php?date">Date</option>
                            <option value="processing-new.php?oil">Oil Company</option>
                        </select>
                    </form>
                </td>
                <td valign="bottom" nowrap>
                    ...
                    if(isset($_GET['jcn'])){
						...
						$_SESSION['search'] = "jcn";
                    ?>
                        <form name="form2" method="post" action="processing-new.php?jcn">
                    ...
                    if(isset($_GET['in'])){
						...
						$_SESSION['search'] = "in";
						?>
						<form name="form2" method="post" action="processing-new.php?in">
                    ...
                    if(isset($_GET['qn'])){
						...
						$_SESSION['search'] = "qn";
                    ?>
                        <form name="form2" method="post" action="processing-new.php?qn">
                    ...
                    ?>
                        <form name="form2" method="post" action="processing-new.php?date">
                    ...
                    ?>
                        ...
                        <form name="form2" method="post" action="processing-new.php?oil">
                    ...
                    <?php if(isset($_GET['area'])){ ?>
                        <form name="form2" method="post" action="processing-new.php?rea">
                    ...
                    <td>
                        <div id="list-border" style="margin-top:15px">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr class="row1">
                                  <td class="td-right">
                                      <textarea name="inv-no" id="inv-no" class="tarea-100 mceEditor" rows="3" placeholder="Invoice Numbers (eg. 46367 46368 46369)"><?php 
									  if(!empty($post_inv)){
                  ...
                  <td><div id="list-border">
                            ...
                            <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="combo">
                                ...
                                <tr class="<?php echo ($ac_sw1++%2==0)?" even":"odd"; ?>
                                    ...
                                    if(in_array($row_Recordset3['InvoiceNo'], $inv_array)){
