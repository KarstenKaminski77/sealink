...
if(isset($_GET['AddLabour']) || isset($_GET['AddMaterial']) || isset($_GET['AddTransport']) || isset($_GET['Delete'])){
	...
	if(isset($_GET['AddLabour'])){
		...
		$form_data['Status'] = $row_jc['Status'];

		dbInsert('tbl_jc', $form_data, $con);
		header('Location: scheduled-maintenance-calc.php?Id='. $_GET['Id'] . $form_param .'#Labour');
	...
	if(isset($_GET['AddMaterial'])){
		...
		dbInsert('tbl_jc', $form_data, $con);
		header('Location: scheduled-maintenance-calc.php?Id='. $_GET['Id'] . $form_param .'#Material');
	...
	if(isset($_GET['AddTransport'])){
		...
		header('Location: scheduled-maintenance-calc.php?Id='. $_GET['Id'] . $form_param .'#Transport');
	...
	if(isset($_GET['Delete'])){
		...
		header('Location: scheduled-maintenance-calc.php?Id='. $_GET['Id'] . $form_param .'#Delete');
...
if(isset($_POST['update'])){
	...
	if(isset($_POST['in-progress'])){
		...
		if(empty($_POST['service'])){
			...
			header('Location: scheduled-maintenance-calc.php?Id='. $_GET['Id'] .'&Service');
	...
	if(isset($_POST['costing']) || isset($_POST['request-pre-po'])){
		...
		if(empty($_POST['service']) || empty($_POST['feedback']) || empty($_POST['reference'])) {
            ...
            header('Location: scheduled-maintenance-calc.php?Id='.$jobid);
	...
	header('Location: scheduled-maintenance-calc.php?Id='. $_GET['Id'] .'#Btm');
}
        ...
        <!-- End Warning Messages -->
          ...
          <div id="list-border" style="margin-top:15px">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                ...
                <td colspan="5" class="td-sub-header">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="15" align="right"><a href="scheduled-maintenance-calc.php?Id=<?php echo $_GET['Id']; ?>&AddLabour" class="add-row-jc"></a></td>
                    </tr>
                </table></td>
              </tr>
              ...
              <tr>
                ...
                <td class="td-right">
                  <a href="scheduled-maintenance-calc.php?Id=<?php echo $_GET['Id']; ?>&Delete=<?php echo $row['Id']; ?>" class="remove"></a>
                ...
                <td colspan="5" class="td-sub-header">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="15"><a href="scheduled-maintenance-calc.php?Id=<?php echo $_GET['Id']; ?>&AddMaterial" class="add-row-jc"></a></td>
                    </tr>
                </table></td>
              </tr>
              <?php
                ...
                <td colspan="5" class="td-sub-header">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="15"><a href="scheduled-maintenance-calc.php?Id=<?php echo $_GET['Id']; ?>&AddTransport" class="add-row-jc"></a></td>
                    </tr>
                </table></td>
              </tr>
              <?php
          ...
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr>
              ...
              <td align="right">
                <?php if(!empty($row_jc['RefNo'])){ ?>
                    <a href="../pdf/pdf-scheduled-maintenance.php?Id=<?php echo $_GET['Id']; ?>&InvoiceNo=<?php echo $row_jc['InvoiceNo']; ?>&Tax" class="btn-new fancybox">Email Invoice</a> 
                <?php } ?>
