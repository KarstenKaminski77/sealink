...
SELECT
    ...
    tbl_areas.Area,
    tbl_companies.Name,
    tbl_companies.Payment,
    tbl_sent_invoices.Proforma,
    tbl_sent_invoices.InvoiceNo AS InvoiceNo_1
FROM
    tbl_sent_invoices
    LEFT JOIN tbl_jc ON tbl_jc.JobId = tbl_sent_invoices.JobId
    ...
    <div id="main-wrapper">
        ...
        <form action="../PHPExcel/create-export.php" method="post" enctype="multipart/form-data" name="form2">
                            ...
                            <tr>
                                <td>
                                    <select name="jumpMenu" class="select" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)">
                                        <?php do { ?>
                                            <option value="debtors.php?Company=<?php echo $row_Recordset4['Id']; ?>" <?= (isset($_GET['Company'] ) && $_GET['Company'] == $row_Recordset4['Id']) ? 'selected="selected"' : ''; ?>><?php echo $row_Recordset4['Name']; ?></option>
            ...
            <div id="list-border">
                <table width="100%" border="0" cellpadding="3" cellspacing="1">
                    <tr>
                        <td colspan="10" align="right"><span class="total-container">Total: R<?= $sumDebtors; ?></span>
                        </td>
                    </tr>
                </table>
                <table id="myTable" class="display" width="100%">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($results)) :
                            $jobid = $row['JobId'];
                            if (empty($row['Proforma'])) {
                                $url = '../revive.php?Id=' . $row['JobId'];
                                $site = $row['Name_1'];
                                $pdf = '../fpdf16/inv-preview.php?Id=' . $row['JobId'];
                            } else {
                                $url = 'scheduled-maintenance-calc.php?menu=' . $_GET['menu'] . '&Id=' . $row['JobId'] . '&job';
                                $site = 'Scheduled Maintenance';
                                $pdf = '../pdf/pdf-scheduled-maintenance.php?Id=' . $row['JobId'] . '&Preview';
                            }
                            $overdue = (round((time() - strtotime($row['Days'])) / 86400) > $row['Payment']) ? ' style="color:#FF0000"' : '';
                        ?>
                            <tr>
                                <td>
                                    <a <?= $overdue; ?> href="">
                                ...
                                <?php if ($_COOKIE['userid'] == 50 || $_COOKIE['userid'] == 142) : ?>
                                    <td>
                                        <a <?= $overdue; ?> href="?archive=<?= $jobid ?>">
                                            Archive
                                        </a>
                                    </td>
                                <?php endif; ?>
                                <td align="center">
                                    <a href="<?php echo $pdf; ?>" target="_blank" title="View PDF" class="view"></a>
                                    <!-- <a href="<?php echo $pdf; ?>" target="_blank" title="View PDF" class="view fancybox"></a> -->
                                </td>
                                <td align="center">
                                    <a onClick="return confirmSubmit()" href="<?= $url; ?>" class="edit" title="Edit"></a>
                                </td>
                                <td align="center">
                                    <a href="../jc_history.php?Id=<?= $jobid ?>"" title=" Mail History" class="icon-info"></a>
                                </td>
                                <td align="center">
                                    <a href="../fpdf16/pdf/credit-pdf.php?Id=<?= $jobid ?>"" class=" icon-credit" title="Credit Note"></a>
                                </td>
                                <td align="center">
                                    <input name="file[]" type="checkbox" id="file[]" value="<?= $jobid ?>"">
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
                    ...
                    <tr class="<?php echo ($ac_sw1++ % 2 == 0) ? "odd" : "even"; ?>"
                        ...
                        <td align="center" nowrap class="combo row-2-1">
                            <a href="#" class="menu" <?php debtors_overdue($jobid); ?>
                                title="<?php echo $row_Recordset3['JobDescription']; ?>">B<?php echo $row_Recordset3['BatchNo']; ?></a>
                        </td>
                        ...
                        <td class="combo row-2-1" <?php debtors_overdue($jobid); ?>>
                            <a href="#" class="menu" <?php debtors_overdue($jobid); ?>
                                title="<?php echo $row_Recordset3['JobDescription']; ?>">Batch Invoice</a>
                        </td>
                        <td class="combo row-2-1" <?php debtors_overdue($jobid); ?>>
                            <a href="#" class="menu" <?php debtors_overdue($jobid); ?>
                                title="<?php echo $row_Recordset3['JobDescription']; ?>"><?php echo $row_batch_total['Date']; ?></a>
                        </td>
                        <td nowrap class="combo row-2-1" <?php debtors_overdue($jobid); ?>>
                            <a href="#" class="menu" <?php debtors_overdue($jobid); ?>
                                title="<?php echo $row_Recordset3['JobDescription']; ?>">R<?php echo number_format($row_batch_total['Total'], 2); ?></a>
                        </td>
                        <?php if ($_COOKIE['userid'] == 50 || $_COOKIE['userid'] == 142) : ?>
                        ...
                        <?php endif; ?>
                        <td align="center" class="combo row-2-1">
                            <a href="../pdf/pdf-batch.php?Batch=<?php echo $row_Recordset3['BatchNo']; ?>&Preview"
                                target="_blank" title="View PDF" class="view fancybox"></a>
                        </td>
                        <td align="center" class="combo row-2-1">
                            <a onClick="return confirmSubmit()"
                                href="<?php echo 'processing.php?Update=' . $row_Recordset3['BatchNo']; ?>" class="edit"
                                title="Edit Batch Invoice"></a>
                        </td>
                        <td align="center" class="combo row-2-1">
                            <a href="#" title="Mail History" class="expand toggler" view="1"></a>
                        </td>
                        <td align="center" class="combo row-2-1">
                            <a href="../fpdf16/pdf/credit-pdf.php?Id=<?php echo $row_Recordset3['BatchNo']; ?>"
                                class="icon-credit" title="Credit Note"></a>
                        </td>
                        <td align="center" class="combo row-2-1">
                            <input name="batch[]" type="checkbox" id="btch[]"
                                value="<?php echo $row_Recordset3['BatchNo']; ?>">
                        </td>
                    </tr>
                    ...
                    <tr style="display:none" class="row1">
                        <td align="center" nowrap class="td-batch-sub-header">
                            <a href="#" class="menu" <?php debtors_overdue($jobid); ?>
                                title="<?php echo $row_batch['JobDescription']; ?>"><?php echo $row_batch['InvoiceNo']; ?></a>
                        </td>
                        <td nowrap class="td-batch-sub-header" <?php debtors_overdue($jobid); ?>>
                            <a href="#" class="menu" <?php debtors_overdue($jobid); ?>
                                title="<?php echo $row_batch['JobDescription']; ?>"><?php echo $row_Recordset3['Name']; ?></a>
                        </td>
                        <td class="td-batch-sub-header" <?php debtors_overdue($jobid); ?>>
                            <a href="#" class="menu" <?php debtors_overdue($jobid); ?>
                                title="<?php echo $row_batch['JobDescription']; ?>"><?php echo $row_batch['Name']; ?></a>
                        </td>
                        <td class="td-batch-sub-header" <?php debtors_overdue($jobid); ?>>
                            <a href="#" class="menu" <?php debtors_overdue($jobid); ?>
                                title="<?php echo $row_batch['JobDescription']; ?>"><?php echo $row_batch['date_for_sort']; ?></a>
                        </td>
                        <td nowrap class="td-batch-sub-header" <?php debtors_overdue($jobid); ?>>
                            <a href="#" class="menu" <?php debtors_overdue($jobid); ?>
                                title="<?php echo $row_batch['JobDescription']; ?>">R<?php echo number_format($row_batch['Total2'], 2); ?></a>
                        </td>
                        <?php if ($_COOKIE['userid'] == 50 || $_COOKIE['userid'] == 142) : ?>
                        <td align="center" class="combo row-2-1">
                            <a href="?archive=<?= $jobid ?>" title="Archive" class="">Archive</a>
                        ...
                        <td align="center" class="td-batch-sub-header">
                            <a href="<?php echo '../fpdf16/inv-preview.php?Id=' . $row_batch['JobId']; ?>"
                                target="_blank" title="View PDF" class="view fancybox"></a>
                        </td>
                        <td align="center" class="td-batch-sub-header">
                            <a onClick="return confirmSubmit()"
                                href="<?php echo 'inv-calc.php?Id=' . $row_batch['JobId']; ?>" class="edit"
                                title="Edit Invoice"></a>
                        </td>
                        <td align="center" class="td-batch-sub-header">
                            <a onClick="return confirmSubmit()" href="<?php echo $url; ?>" class="icon-info"
                                title="Edit"></a>
                        </td>
                        <td align="center" class="td-batch-sub-header">
                            <a href="debtors.php?BatchRemove=<?php echo $row_batch['JobId']; ?>&Batch=<?php echo $row_batch['Id']; ?>"
                                title="Remove From Batch" class="delete"></a>
                        </td>
                                ...
                                ?>
                                    ...
                                    <tr class="<?php echo ($ac_sw1++ % 2 == 0) ? "odd" : "even"; ?>" onMouseOver="this.oldClassName = this.className; this.className='over';" onMouseOut="this.className = this.oldClassName;">
                                        <td align="center" nowrap class="combo">
                                            <a href="#" class="menu" <?= $overdue; ?> title="<?php echo $row_Recordset3['JobDescription']; ?>"><?php echo $row_Recordset3['InvoiceNo_1']; ?></a>
                                        </td>
                                        <td nowrap class="combo" <?= $overdue; ?>>
                                            <a href="#" class="menu" <?= $overdue; ?> title="<?php echo $row_Recordset3['JobDescription']; ?>"><?php echo $row_Recordset3['Name']; ?></a>
                                        </td>
                                        <td class="combo" <?= $overdue; ?>>
                                            <a href="#" class="menu" <?= $overdue; ?> title="<?php echo $row_Recordset3['JobDescription']; ?>"><?php echo $site; ?></a>
                                        </td>
                                        <td class="combo" <?= $overdue; ?>>
                                            <a href="#" class="menu" <?= $overdue; ?> title="<?php echo $row_Recordset3['JobDescription']; ?>"><?php echo $row_Recordset3['date_for_sort']; ?></a>
                                        </td>
                                        <td nowrap class="combo" <?= $overdue; ?>>
                                            <a href="#" class="menu" <?= $overdue; ?> title="<?php echo $row_Recordset3['JobDescription']; ?>">R<?php echo $row_Recordset3['Total2']; ?></a>
                                        </td>
                                        <?php if ($_COOKIE['userid'] == 50 || $_COOKIE['userid'] == 142) : ?>
                                            <td align="center" class="combo row-2-1">
                                                <a href="?archive=<?= $jobid ?>" title="Archive" class="">Archive</a>
