...
if(isset($_POST['send']) && empty($errors)){
	...
	$mail->addAttachment('../pdf/pdf/Seavest Tax Invoice #' . $_GET['InvoiceNo'] . '.pdf');
...
<form id="form1" name="form1" method="post" action="">
  ...
  <div id="list-border">
    <table width="100%" border="0" cellspacing="1" cellpadding="0">
      <tr>
        <td colspan="2" align="center" class="td-header">Email Tax Invoice #<?php echo $_GET['InvoiceNo']; ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="td-right"><input name="subject" type="text" class="tarea-100" id="subject" value="Seavest Tax Invoice #<?php echo $_GET['InvoiceNo']; ?>" /></td>
      </tr>
      <tr>
