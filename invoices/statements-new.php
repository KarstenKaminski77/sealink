                            ...
                            <table width="100%" align="center" cellpadding="3" cellspacing="1">
                                ...
                                <tr class="<?php echo ($ac_sw1++%2==0)?" odd ":"even "; ?>" onMouseOver="this.oldClassName = this.className; this.className='over';" onMouseOut="this.className = this.oldClassName;">
                                  ...
                                  <td class="combo">&nbsp;<?php echo $row_Recordset3['DateGenerated']; ?></td>
                                    <td align="center">
                                        <a href="../fpdf16/pdf/<?php echo $row_Recordset3['FileName']; ?>" class="icon-pdf fancybox"></a>
                                  </td>
                                    <td align="center">
                                        <a href="../fpdf16/pdf/statement-download.php?Id=<?php echo $row_Recordset3['FileName']; ?>" class="download fancybox"></a>
                                    </td>
                                    <td align="center">
