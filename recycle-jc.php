...
if(isset($_GET['Id'])){
	...
	mysqli_query($con, "DELETE FROM tbl_jc WHERE JobId = '$jobid'")or die(mysqli_error($con));
	
}

mysqli_select_db($con, $database_seavest);
...
?>
                      <tr class="<?php echo ($ac_sw1++%2==0)?"odd":"even"; ?>" onMouseOver="this.oldClassName = this.className; this.className='list-over';" onMouseOut="this.className = this.oldClassName;">
                        <td width="100"><a href="jc_calc.php?Id=<?php echo $row_Recordset3['JobId']; ?>&job" class="menu" title="<?php echo $row_Recordset3['JobDescription']; ?>"><?php echo $row_Recordset3['JobNo']; ?></a></td>
                        ...
                        <td width="40" align="center"><a href="recycle-jc.php?Id=<?php echo $row_Recordset3['JobId']; ?>"><img src="images/icons/btn-bin.png" width="25" height="25" border="0"></a></td>
                        </tr>
                      <?php } 
