...
<form class="example" name="form1" method="post" action="search.php">
    ...
    <div id='cssmenu'>
        <ul class="">
            ...
            $query_menu_cat = "
                ...
                WHERE
                tbl_menu_user_relation.UserId = '$user_id'
                GROUP BY
                tbl_menu_sub_cat.CatId
                ORDER BY
            ...
            ?>
                <li class='active has-sub active <?php echo $row_menu_cat['URL']; ?> <?php echo $first; ?>'><a href='#'><span><?php echo $row_menu_cat['Category']; ?></span></a>
                    <ul>
                        <?php
                        ...
                        ?>
                            ...
                            <li class='has-sub <?php echo $row_sub_cat['URL']; ?>'><a href='#'><span><?php echo $row_sub_cat['SubCat']; ?></span></a>
