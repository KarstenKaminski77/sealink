...
if(isset($_POST['reset'])){
   ...
   $edit = $_GET['Edit'];
	...
	$query_list = mysqli_query($con, "SELECT * FROM tbl_sm_assets ORDER BY Asset ASC")or die(mysqli_error($con));
            ...
            <div id="list-border">
              <table width="100%" border="0" cellpadding="4" cellspacing="1">
                ...
                <tr class="<?php echo ($ac_sw1++%2==0)?" even ":"odd "; ?>" onmouseover="this.oldClassName = this.className; this.className='over';" onmouseout="this.className = this.oldClassName;">
                  ...
                  <td align="center">
                    <a href="../SLA/assets.php?Delete=<?php echo $row_list['Id']; ?>" title="Delete" class="delete" onclick = "if (!confirm('Delete <?php echo $row_list['Category']; ?>?')){ return false; }"></a>
                  </td>
                  <td align="center">
                    <a href="../SLA/assets.php?Edit=<?php echo $row_list['Id']; ?>" title="Edit" class="edit"></a>
                  </td>
                </tr>
                <?php } ?>
              </table>
