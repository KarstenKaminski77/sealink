            ...
            <div id="list-brdr-supprt">
              <table width="100%" border="0" cellspacing="1" cellpadding="0">
                <tr>
                  ...
                  <td class="td-right">
                    <input name="name" type="text" class="tarea-100" id="name" value="<?php echo $row_form['Name']; ?>">
                  </td>
                  <td width="120" class="td-left">Email</td>
                  <td class="td-right">
                    <input name="email" type="text" class="tarea-100" id="email" value="<?php echo $row_form['Email']; ?>">
                  </td>
                </tr>
                <tr>
                  <td class="td-left">Username</td>
                  <td class="td-right">
                    <input name="username" type="text" class="tarea-100" id="username" value="<?php echo $row_form['Username']; ?>">
                  </td>
                  <td class="td-left">Password</td>
                  <td class="td-right">
                    <input name="password" type="text" class="tarea-100" id="password" value="<?php echo $row_form['Password']; ?>">
                  </td>
                </tr>
                <tr>
                  <td class="td-left">Override SLA</td>
                  <td colspan="3" class="td-right"><table border="0" cellspacing="1" cellpadding="0">
                    <tr>
                      <td><input type="radio" name="sla" id="radio" value="1" <?php if($row_form['OverrideSLA'] == 1){ echo 'checked="checked"'; } ?> /></td>
                      <td class="combo-right"><label for="radio">Yes</label></td>
                      <td width="10">&nbsp;</td>
                      <td><input type="radio" name="sla" id="radio2" value="0" <?php if($row_form['OverrideSLA'] == 0){ echo 'checked="checked"'; } ?> /></td>
