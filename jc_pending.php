	...
	<table width="750" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
            ...
            <tr>
              <td colspan="4"><table width="650" border="0" align="center" cellpadding="3" cellspacing="1">
                <tr class="td-header">
                  ...
                  <td width="80" align="left"><strong>Age</strong></td>
...
?>
  <tr class="<?php echo ($ac_sw1++%2==0)?"odd":"even"; ?>" onMouseOver="this.oldClassName = this.className; this.className='list-over';" onMouseOut="this.className = this.oldClassName;">
    <td width="100" style="padding-left:2px; padding-right:2px"><a href="jc_calc.php?menu=<?php echo $_GET['menu']; ?>&Id=<?php echo $row_Recordset3['JobId']; ?>&job" class="menu" title="<?php echo $row_Recordset3['JobDescription']; ?>"><?php echo $row_Recordset3['JobNo']; ?></a></td>
    <td width="150" style="padding-left:2px; padding-right:2px"><a href="jc_calc.php?menu=<?php echo $_GET['menu']; ?>&Id=<?php echo $row_Recordset3['JobId']; ?>&job" class="menu"><?php echo $row_Recordset3['Name']; ?></a></td>
    <td width="250" style="padding-left:2px; padding-right:2px"><a href="jc_calc.php?menu=<?php echo $_GET['menu']; ?>&Id=<?php echo $row_Recordset3['JobId']; ?>&job" class="menu" title="<?php echo $row_Recordset3['CommentText']; ?>"><?php echo $row_Recordset3['Name_1']; ?></a></td>
    <td width="80" nowrap style="padding-left:2px; padding-right:2px"><a href="jc_calc.php?menu=<?php echo $_GET['menu']; ?>&Id=<?php echo $row_Recordset3['JobId']; ?>&job" class="menu"><?php time_schedule($jobid); ?></a></td>
                          <td width="40">
                            <?php
						  $jobid = $row_Recordset3['JobId'];
