...
$query_total = "
  SELECT
  SEC_TO_TIME(
		  SUM(TIME_TO_SEC(tbl_time_log.Difference))
	  ) AS TotalTime,
  tbl_support.Date
  FROM
  tbl_time_log
  ...
  WHERE
	  YEAR (tbl_support.AllocatedDate) = '$year'
  AND MONTH (tbl_support.AllocatedDate) = '$month'";
                       ...
                       <tr>
                         ...
                         <div id="list-border">
                           <table width="100%" border="0" cellspacing="1" cellpadding="2">
                              ...
                              <tr>
                                <td width="12%" valign="top" class="td-left">Hours Used</td>
                                <td width="38%" class="td-right"><?php echo gmdate('H:i:s',(strtotime('18:00:00') - strtotime($row_total['TotalTime']))); ?> hrs</td>
                                <td width="12%" valign="top" class="td-left">Allocated</td>
                                <td width="38%" class="td-right">&nbsp;</td>
                              </tr>
                           </table>
                        ...
                        <tr>
                          <td><div id="list-brdr-supprt">
                            <table width="100%" border="0" cellpadding="4" cellspacing="1" class="comb-sms">
                              <tr>
                                <td width="50" class="td-header">Ref No</td>
                                <td width="150" class="td-header">Date</td>
                                <td class="td-header">Requestor</td>
                                <td width="100" class="td-header">Job No</td>
                                <td width="100" class="td-header">Location</td>
                                <td width="75" class="td-header">Time Logged</td>
                              ...
                              <tr class="<?php echo ($ac_sw1++%2==0)?"odd":"even"; ?>" onMouseOver="this.oldClassName = this.className; this.className='list-over';" onMouseOut="this.className = this.oldClassName;">
                                ...
                                <td class="td-combo"><?php echo $row['JobStatus']; ?></td>
                                <td class="td-combo"><?php echo $result; ?></td>
