...
include('../menu.php'); ?>
    ...
    <td valign="top"><table width="823" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><br>
          <br>
          <form method="post" name="form" id="form" style="padding-left:30px" action="compose.php">
              ...
              <tr>
                <td><div id="CollapsiblePanel1" class="CollapsiblePanel">
                  ...
                  <div class="CollapsiblePanelContent">
                    <div id="comb-sms">
                      <textarea name="message" rows="5" style="width:98%" class="ta-sms" id="message" onFocus="if (this.value=='Message') this.value='';" onBlur="if (this.value.replace(/\s/g,'')=='') this.value='Message';" >Message</textarea>
                    </div>
                  </div>
                </div>
...
?>
                            <td><table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <td><div class="comb-sms" style="padding-right:20px">
                                  <label for="<?php echo $row_Recordset3['Id']; ?>"><?php echo $row_Recordset3['Name']; ?></label>
                                </div></td>
                              </tr>
                            </table></td>
                            <?php
...
?>
                  ...
                  <div id="CollapsiblePanel3" class="CollapsiblePanel">
                    ...
                    <div class="CollapsiblePanelContent">
                      <div id="comb-sms">
                        <table align="center">
                          <tr>
                            <td width="230" align="right" class="comb-sms">Add Number</td>
                            <td width="28" align="right"><input name="add" type="submit" class="new-supplier" id="add" value="" onClick="document.form.action='compose.php?col3=open#CollapsiblePanel3'; document.form.submit();"></td>
                          </tr>
                          <?php 
					  ...
					  ?>
                          <tr>
                            <td colspan="2" align="center"><input name="cell[]" type="text" class="td-sms" id="cell[]" value="<?php echo $cell_no; ?>"></td>
                          </tr>
                          <?php } ?>
                        </table>
                      </div>
              ...
              <tr>
                <td align="right"><br>                  <input name="send" type="submit" class="btn-send-sms" id="send" value=""></td>
              </tr>
            </table>
          </form></td>
      </tr>
