...
$tfi_listtbl_users1->addColumn("Name", "STRING_TYPE", "Name", "%");
...
$tso_listtbl_users1->addColumn("Name");
...
$query_rstbl_users1 = sprintf("SELECT tbl_users.Username, tbl_users.Password, tbl_users.Name, tbl_users.Id FROM tbl_users WHERE %s ORDER BY %s", $NXTFilter_rstbl_users1, $NXTSort_rstbl_users1);
...
?>
          ...
          <tr>
            ...
            <td><input type="text" name="Email_<?php echo $cnt1; ?>" id="Email_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rstbl_users['Email']); ?>" size="32" />
                        ...
                        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                          <thead>
                            <tr class="KT_row_order">
                              ...
                              <th id="Name" class="KT_sorter KT_col_Name <?php echo $tso_listtbl_users1->getSortIcon('Name'); ?>"> <a href="<?php echo $tso_listtbl_users1->getSortLink('Name'); ?>">Name</a></th>
...
?>
                              <tr class="KT_row_filter">
                                <td>&nbsp;</td>
                                <td><input type="text" name="tfi_listtbl_users1_Name" id="tfi_listtbl_users1_Name" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listtbl_users1_Name']); ?>" size="10" maxlength="100" /></td>
                            ...
                            <?php if ($totalRows_rstbl_users1 > 0) { // Show if recordset not empty ?>
                              <?php do { ?>
                                <tr class="<?php echo @$cnt4++%2==0 ? "" : "KT_even"; ?>">
                                  ...
                                  <td><div class="KT_col_Name"><?php echo KT_FormatForList($row_rstbl_users1['Name'], 20); ?></div></td>
