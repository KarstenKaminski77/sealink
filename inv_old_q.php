              ...
              <td class="combo"><div style="border:solid 1px #A6CAF0;">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
					  ...
					  <div id="add_row" style="margin-top:4px; margin-left:4px; margin-right:4px;">
					  <table width="100%" border="0" cellpadding="3" cellspacing="0" class="combo_bold">
                        <tr>
                          ...
                          <td width="25%" align="right" valign="middle"><form name="form3" method="post" action="inv_mail.php?Id=<?php echo $_GET['Id']; ?>">
                    ...
                    <tr>
                      <td colspan="2" valign="top"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="combo">
                          ...
                          <tr>
                            <td><div id="BLOCK"><span class="combo_bold"><?php echo $row_Recordset5['Name']; ?><br>
							...
							echo $row_Recordset5['Email']; ?>
                                  <br>
                                  <?php } ?>
VAT NO: <?php echo $row_Recordset5['VATNO']; ?></span><br>
                            <br>
                            </div></td>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                    <tr>
                      <td align="left" bordercolor="#A6CAF0"><br>
                        ...
                        <?php
$query = "SELECT * FROM tbl_jc WHERE JobId = '$jobid' AND Labour1 = '1' ORDER BY Id ASC";
...
?>
                        ...
                        <br>
                        <br>
                        &nbsp; <span class="combo_bold">Material
                        </span>
                        <?php
...
?>
                        <table width="100%" border="0" cellpadding="0" cellspacing="1">
                          <tr>
                            ...
                            <td width="50" align="center" valign="bottom" class="combo2"><?php echo $row['Unit1']; ?></td>
                            <td width="50" align="center" valign="bottom" class="combo2"><?php echo $row['Qty1']; ?></td>
                            <td width="100" align="center" valign="bottom" class="combo2">R<?php echo $row['Price1']; ?></td>
                            <td width="50" align="center" valign="bottom" class="combo">R<?php echo $row['Total3']; ?>&nbsp;&nbsp; </td>
                          </tr>
                        </table>
                        <?php } // close loop ?>
...
?>
                        <table width="100%" border="0" cellpadding="0" cellspacing="1">
                          <tr>
                            ...
                            <td width="50" align="center" valign="bottom" class="combo2"><?php echo $row['Qty1']; ?></td>
                            <td width="100" align="center" valign="bottom" class="combo2">R<?php echo $row_Recordset8['Rate1']; ?></td>
                            <td width="50" align="center" valign="bottom" class="combo">R<?php echo $row['Total3']; ?>&nbsp;&nbsp; </td>
                          </tr>
                        </table>
                        <?php } // close loop ?>
                          ...
                          <tr>
                            <td align="right" class="combo_bold"><table border="0" cellpadding="0" cellspacing="3" class="combo2">
                                <tr>
                                  ...
                                  <td align="right" nowrap class="combo_bold">R<?php echo $row_Recordset9['VatIncl']; ?></td>
                                </tr>
                                <tr>
                                  <td nowrap class="combo_bold">Vat: </td>
                                  <td align="right" nowrap class="combo_bold">
								  <?php vat_quote($jobid); ?>                                  </td>
                                </tr>
                                <tr>
