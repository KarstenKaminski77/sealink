...
if(isset($_POST['submit'])){
	...
	mysql_query("INSERT INTO tbl_incident_reports (Date, Technician, Topic, Location, Comments) VALUES ('$date','$technician','$topic','$location','$comments')")or die(mysql_error());
...
if(isset($_POST['search'])){
	...
	if(!empty($_POST['location2'])){
		...
		$string .= ' Location LIKE "%'. $location2 .'%" AND';
...
mysql_select_db($database_seavest, $seavest);
$query_Recordset2 = "SELECT * FROM tbl_incident_reports $string ORDER BY Date ASC";
      ...
      <tr>
        <td><p><br>
          ...
          <div style="padding-left:30px">
            <form name="form2" method="post" action="incident-reports.php">
...
?>
                ...
                <tr>
                  <td>Date</td>
                  <td><input name="date" class="td-mail" id="date" style="width:300px;" value="" wdg:mondayfirst="true" wdg:subtype="Calendar" wdg:mask="<?php echo $KT_screen_date_format.' '.$KT_screen_time_format; ?>" wdg:type="widget" wdg:singleclick="true" wdg:restricttomask="no"></td>
                </tr>
                <tr>
                  <td valign="top">Topic</td>
                  <td><input name="topic" type="text" class="td-mail" id="topic" style="width:300px"></td>
                </tr>
                <tr>
                  <td valign="top">Location</td>
<td><input name="location" type="text" class="td-mail" id="location" style="width:300px"></td>
                </tr>
                <tr>
                  <td valign="top">Comments</td>
                  <td><textarea name="comments" cols="45" rows="5" class="td-mail" id="comments" style="width:300px"></textarea></td>
                </tr>
                <tr>
                  <td valign="top">&nbsp;</td>
            ...
            <table border="0" cellpadding="3" cellspacing="1" class="combo">
              <tr>
                <td colspan="5"><form name="form3" method="post" action="incident-reports.php">
                  <table border="0" cellpadding="2" cellspacing="3" class="combo">
                    <tr>
...
?>
                      ...
                      <td><input type="text" name="topic2" id="topic2" style="width:100px"></td>
                      <td><input type="text" name="location2" id="location2" style="width:100px"></td>
                      <td><span class="test">
              ...
              <tr>
                <td colspan="5"><?php echo $totalRows_Recordset2 .' Results'; ?></td>
              </tr>
              <?php } ?>
              <tr>
                <td colspan="5">&nbsp;</td>
...
<tr class="<?php echo ($ac_sw1++%2==0)?"odd":"even"; ?>" onMouseOver="this.oldClassName = this.className; this.className='list-over';" onMouseOut="this.className = this.oldClassName;">
                  <td width="150"><?php echo $row_Recordset2['Date']; ?></td>
                  <td width="150"><?php echo $row_Recordset2['Technician']; ?></td>
                  <td width="200"><?php echo $row_Recordset2['Topic']; ?></td>
                  <td width="100"><?php echo $row_Recordset2['Location']; ?></td>
                  <td width="300"><?php echo $row_Recordset2['Comments']; ?></td>
              </tr>
