...
mysql_select_db($database_seavest, $seavest);
$query_Recordset2 = sprintf("SELECT tbl_qs.CompanyId, tbl_qs.QuoteNo, tbl_qs.Total, tbl_qs.Attention, tbl_companies.* FROM (tbl_qs LEFT JOIN tbl_companies ON tbl_companies.Id=tbl_qs.CompanyId) WHERE tbl_qs.QuoteNo=%s ", $KTColParam1_Recordset2);
...
<table width="650" border="0" cellpadding="0" cellspacing="5">
  ...
  $sectemailObj->setFrom("hemi@seavest.co.za");
  $sectemailObj->setSubject("SEAVEST AFRICA TRADING CC");
...
?>
  ...
  <td class="combo" colspan="4">
    ...
    <p>&nbsp;  </p></td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="3">
            ...
            <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
              <td valign="top" bordercolor="#FFFFFF" bgcolor="#FFFFFF"><table width="180" border="1" cellpadding="0" cellspacing="1" bordercolor="#FFFFFF">
                  ...
                  <tr>
                    <td bordercolor="#68A4E6" bgcolor="#a6caf0" class="combo"><div style="padding:3px"><span class="combo_bold"><?php echo $row_Recordset2['Name']; ?></span><br>
                            <?php echo nl2br(KT_escapeAttribute($row_Recordset2['Address'])); ?></div></td>
                  </tr>
              </table></td>
              <td valign="top" bordercolor="#FFFFFF" bgcolor="#FFFFFF"><table width="300" border="1" align="right" cellpadding="0" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#FFFFFF" class="tb_border">
                  <tr>
                    <td width="120" bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border"><span class="combo_bold">Date:</span></td>
                    <td bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border">&nbsp;<?php echo $row_Recordset5['Date']; ?></td>
                  </tr>
                  <tr>
                    <td width="120" bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border"><span class="combo_bold">Quotation Number: </span></td>
                    <td bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border">&nbsp;<?php echo $row_Recordset5['QuoteNo']; ?></td>
                  </tr>
                        <tr>
                          <td bordercolor="#68A4E6" bgcolor="#A6CAF0" class="combo_bold">FMC:</td>
                          <td bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border"><input name="fmc" type="text" class="tarea3" id="fmc" style="cursor:text" value="<?php fmc($quoteno); ?>"></td>
                        </tr>
                  <tr>
                    <td width="120" bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border"><span class="combo_bold">Site / Customer:</span></td>
                    <td bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border">&nbsp;<?php echo $row_Recordset5['Name_1']; ?></td>
                  </tr>
                  <tr>
                    <td bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border"><span class="combo_bold">Address:</span></td>
                    <td bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border">&nbsp;<?php echo $row_Recordset5['Address']; ?></td>
                  </tr>

                  <tr>
                    <td width="120" bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border"><span class="combo_bold">Description:</span></td>
                    <td bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border">&nbsp;<?php echo $row_Recordset5['JobDescription']; ?></td>
                  </tr>
                  <tr>
                    <td width="120" bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border"><span class="combo_bold">Att:</span></td>
                    <td bordercolor="#68A4E6" bgcolor="#A6CAF0" class="tb_border">&nbsp;<?php echo $row_Recordset2['Attention']; ?></td>
                  </tr>
              </table></td>
            </tr>
            <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
		...
		<table width="762" border="1" cellpadding="2" cellspacing="1" bordercolor="#FFFFFF" class="combo">
          <tr>
            ...
            <td width="100" align="center" bordercolor="#68A4E6" bgcolor="#A6CAF0" class="combo_bold">Total</td>
          </tr>
        </table>
...
?>
                    <div>
                      <table width="750" border="0" cellpadding="0" cellspacing="0" class="combo">
                        <tr>
                          <td width="450"><div style="padding:5px; padding-right:5px; padding-top:5px; text-align:justify; width:430px"><?php echo $row['Description']; ?></div></td>
...
?>
                    <div>
                      <table width="750" border="0" cellpadding="0" cellspacing="0" class="combo">
                        <tr>
                          <td width="450"><div style="5px; padding-right:5px; padding-top:5px; text-align:justify; width:430px"><?php echo $row['Description']; ?></div></td>
                          <td width="50" align="center" valign="bottom"><?php echo $row['Unit']; ?></td>
                          <td width="50" align="center" valign="bottom"><?php echo $row['Qty']; ?></td>
                          <td width="100" align="center" valign="bottom">R<?php echo $row['Price']; ?></td>
                          <td width="100" align="right" valign="bottom">R<?php echo $row['Total1']; ?>&nbsp;&nbsp;&nbsp;</td>
...
?>
                    <div>
                      <table width="750" border="0" cellpadding="0" cellspacing="0" class="combo">
                        <tr>
                          <td width="224">&nbsp;&nbsp;<?php echo $row['TransportComment']; ?> </td>
              ...
              <div style="padding-right:9px">
                <table border="0" cellpadding="0" cellspacing="3" class="combo2">
                      <tr>
                        <td nowrap class="combo_bold">Sub Total:&nbsp;&nbsp;&nbsp;&nbsp; </td>
                        <td align="right" nowrap class="combo_bold">R <?php echo $row_Recordset4['SUM(Total1)']; ?>
                            <input name="subtotal" type="hidden" id="subtotal" value="<?php echo $row_Recordset4['SUM{Total1)']; ?>"></td>
                      </tr>
                      <tr>
                        <td nowrap class="combo_bold">Vat: </td>
                        <td align="right" nowrap class="combo_bold">R <?php echo $row_Recordset4['SUM(VAT)']; ?></td>
                      </tr>
                      <tr>
                        <td colspan="2" nowrap class="combo_bold"><div style="border-top:solid 1px #A6CAF0;"></div>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr class="combo2">
                                ...
                                <td align="right" nowrap class="combo_bold">R<?php echo $row_Recordset2['Total']; ?></td>
                              </tr>
                            </table>
