        ...
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <table border="0" cellpadding="0" cellspacing="0" class="combo">
                <tr>
                  <td class="combo"><div id="add_row2" style="margin-top:4px; margin-left:0px; margin-right:4px;">
                    <table width="100%" border="0" cellpadding="3" cellspacing="0" class="combo_bold">
                      <tr>
                        <td width="59%" align="right" valign="middle" nowrap><form name="form2" method="post" action="revive.php?Id=<?php echo $_GET['Id']; ?>">
                            <input name="Submit2" type="submit" class="tarea2" value="Edit">
                        </form></td>
                        <td width="25%" align="right" valign="middle" nowrap><form name="form3" method="post" action="inv_q_mail.php?Id=<?php echo $_GET['Id']; ?>">
                            <input name="mail" type="text" class="tarea2" id="mail" style="cursor:text">
                          &nbsp;
                          <input name="Submit3" type="submit" class="tarea2" value="Email">
                        </form></td>
                        <td width="7%" align="right" valign="middle" nowrap><form action="inv_q_print.php?Id=<?php echo $_GET['Id']; ?>" method="post" name="form1" target="_blank">
                            <input name="Submit" type="submit" class="tarea2" value="Print">
                        </form></td>
                        <td width="9%" align="right" valign="middle" nowrap><form name="form4" method="post" action="inv_paid.php?Id=<?php echo $_GET['Id']; ?>">
                ...
                <tr>
                  <td class="combo"><table border="0" cellpadding="0" cellspacing="0" class="combo">
                    <tr>
                            ...
                            <tr>
                              <td width="50%" valign="top"><table width="100%" border="1" cellpadding="0" cellspacing="4" bordercolor="#FFFFFF">
                                  ...
                                  <tr>
                                    ...
                                    <td width="50%" bordercolor="#FFFFFF" class="combo2">&nbsp;<?php echo $row_Recordset5['FirstName']; ?>&nbsp;<?php echo $row_Recordset5['LastName']; ?></td>
                                  </tr>
                              </table></td>
                              <td width="50%" valign="top">&nbsp;</td>
                            </tr>
...
?>
                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                  <tr>
                                    ...
                                    <td width="50" align="center" class="combo2"><?php echo $row['Qty1']; ?></td>
                                    <td width="100" align="center" class="combo2">R<?php echo $row_Recordset8['Rate']; ?></td>
                                    <td width="50" align="center" class="combo">R<?php echo $row['Total3']; ?>&nbsp;&nbsp; </td>
                                  </tr>
                                </table>
                                <?php } // close loop ?>
                                  ...
                                  <tr>
                                    <td align="right" class="combo_bold"><table border="0" cellpadding="0" cellspacing="3" class="combo2">
                                      ...
                                      <tr>
                                        ...
                                        <td align="right" nowrap class="combo_bold"><?php vat_quote($jobid); ?>                                        </td>
                                      </tr>
                                      <tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr class="combo2">
                                            ...
                                            <td align="right" nowrap class="combo_bold"><?php total_quote($jobid); ?>
                                            </td>
                                          </tr>
                                        </table>
										<div style="border-top:solid 1px #A6CAF0;"></div>
