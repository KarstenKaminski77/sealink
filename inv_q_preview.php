...
mysql_select_db($database_seavest, $seavest);
$query_Recordset9 = sprintf("SELECT SUM(Total3) FROM tbl_jc WHERE JobId = %s AND InvoiceQ = '1'", $colname_Recordset9);
...
?>
                ...
                <div style="border-top:solid 1px #A6CAF0; margin-left:5px; margin-right:5px"></div>
                            <table width="760" border="0" cellpadding="0" cellspacing="1">
                              <tr>
                                <td align="right" class="combo_bold">R                              <?php sum_labour_quote($jobid); ?>&nbsp; </td>
                              </tr>
                      </table>
					  <div style="border-top:solid 1px #A6CAF0; margin-left:5px; margin-right:5px"></div>
...
<div style="border-top:solid 1px #A6CAF0; margin-left:5px; margin-right:5px"></div>                          <br>
                <br>
                            ...
                            <tr>
                              <td align="right" class="combo_bold"><table border="0" cellpadding="0" cellspacing="3" class="combo2">
                                <tr>
                                  ...
                                  <td align="right" nowrap class="combo_bold">R<?php echo $row_Recordset9['SUM(Total3)']; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td align="right" nowrap class="combo_bold"><?php total_quote($jobid); ?>								  </td>
                                </tr>
                              </table>                              
                                  
                                <br>                                
