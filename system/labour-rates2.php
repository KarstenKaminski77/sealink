                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <div id="main-wrapper" style="margin-bottom:105px; width: calc(100% - 40px)">
                            ...
                            <form action="labour-rates2.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach($base->list as $list){ ?>
                                                <tr class="odd" onmouseover="this.oldClassName = this.className; this.className='over';" onmouseout="this.className = this.oldClassName;">
                                                    ...
                                                    <td nowrap>
                                                        <a href="labour-rates2.php?delete_id=<?php echo $list['Id']; ?>" class="btn_red" style="font-weight:bold;text-decoration:none;padding:8px;border-radius:5px;font-family:arial">Delete</a>
