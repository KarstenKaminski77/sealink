...
//    ini_set('display_errors', 1);
    ...
    $base->getAreasDd();
    $base->setCompany($base->row['Company']);
    $base->getCompaniesDd();
    $base->getEngineersDd();
    $base->logout_link();
    $base->areaSelect();
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <div id="main-wrapper" style="margin-bottom:105px; width: calc(100% - 40px)">
                            ...
                            <form action="sites.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach($base->list as $list){ ?>
                                                <tr class="odd" onmouseover="this.oldClassName = this.className; this.className='over';" onmouseout="this.className = this.oldClassName;">
                                                    ...
                                                    <td nowrap>
                                                        <a href="sites.php?delete_id=<?php echo $list['Id']; ?>" class="btn_red" style="font-weight:bold;text-decoration:none;padding:8px;border-radius:5px;font-family:arial">Delete</a>
