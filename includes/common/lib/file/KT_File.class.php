...
class KT_file
{
	 ...
	 * @param string $file the folder to be checked;
	 * @param string $mode what to test: read or write;
	 * @param string $from from what class is the call;
	 * @return boolean true if it has the right, false otherwise;
	 * @access public
	 */
