...
// Start Variable definitions
  ...
  $tNG_login_config["connection"] = "seavest";
  $tNG_login_config["table"] = "tbl_users";
  ...
  $tNG_login_config["level_field"] = "UserLevel";
  ...
  $tNG_login_config["redirect_failed"] = "backend/login.php";
  $tNG_login_config["redirect_success"] = "backend/index.php";
  $tNG_login_config["login_page"] = "backend/login.php";
  $tNG_login_config_session["kt_login_id"] = "Id";
  $tNG_login_config_session["kt_login_user"] = "Username";
  $tNG_login_config_session["kt_login_level"] = "UserLevel";
  $tNG_login_config_session["kt_AreaId"] = "AreaId";
  $tNG_login_config_redirect_success["10"] = "backend/index.php";
  $tNG_login_config_redirect_failed["10"] = "backend/login.php";
  $tNG_login_config_redirect_success["1"] = "welcome.php";
  $tNG_login_config_redirect_failed["1"] = "index.php";
  $tNG_login_config_redirect_success["0"] = "jc_select.php?menu=In Progress";
  $tNG_login_config_redirect_failed["0"] = "index.php";
  $tNG_login_config_redirect_success["3"] = "jc_status.php?menu=In Progress";
  $tNG_login_config_redirect_failed["3"] = "index.php";
  $tNG_login_config_redirect_success["2"] = "jc_select.php?menu=In Progress";
