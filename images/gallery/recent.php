...
?>
                      <td align="center" valign="bottom"><table border="0" cellspacing="3" cellpadding="2">
                        <tr>
                          <td align="center">
                          <a href="images/<?php echo $row_Recordset4['Image']; ?>" class="look_inside" onClick="return hs.expand(this, {captionId: 'caption1'})"> <img src="<?php echo $objDynamicThumb1->Execute(); ?>" border="0" class="img_border" /> </a></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
