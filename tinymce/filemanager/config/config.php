...
$base_url='http://www.seavest.co.za';  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = '/inv/tinymce/source/'; // path from base_url to base of upload folder (with start and final /)
