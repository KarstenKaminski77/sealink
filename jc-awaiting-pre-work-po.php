...
?><tr class="<?php echo ($ac_sw1++%2==0)?"odd":"even"; ?>" onMouseOver="this.oldClassName = this.className; this.className='list-over';" onMouseOut="this.className = this.oldClassName;">
              ...
              <td width="30" align="center"><a href="jc_calc.php?Id=<?php echo $jobid; ?>" target="_blank"><img title="View Job Card" src="images/icons/jc.png" width="25" height="25" border="0"></a></td>
              <td width="30" align="center"><a href="fpdf16/pdf_quotation.php?Id=<?php echo $row_Recordset3['QuoteNo']; ?>&preview" target="_blank"> <img title="Quote" src="images/icons/qs.png" width="25" height="25" border="0"></a></td>
              <td align="center">
                <a href="jc-awaiting-pre-work-po.php?Reject=<?php echo $jobid; ?>"><img src="images/icons/btn-delete.png" width="25" height="25" title="Reject"></a>
              </td>
              <td width="30" align="center">
                <a href="javascript:;" onClick="window.open('jc-pre-order-no.php?Approve=<?php echo $jobid; ?>','winname','directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=200')"><img src="images/icons/btn-tick.png" width="25" height="25" title="Add Order No."></a>
              </td>
              </tr>
            <?php } while ($row_Recordset3 = mysqli_fetch_assoc($Recordset3)); ?>
            <?php unset($_SESSION['jobids']); ?>			
            <tr>
            <td colspan="10" align="right" class="td-header">&nbsp;</td>
            </tr>
            </table>
        </form>
        <br><br>
