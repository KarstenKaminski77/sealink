...
$query_Recordset4 = "SELECT tbl_jc.CompanyId, tbl_jc.JobId, tbl_jc.JobNo, tbl_companies.* FROM (tbl_jc LEFT JOIN tbl_companies ON tbl_companies.Id=tbl_jc.CompanyId) WHERE tbl_jc.JobId= '$jobid' ORDER BY Id DESC LIMIT 1";
...
if($jobid == 1770){
$pdf ->Cell(190,10,'18 Feb 2010','','','R');
} else {
$pdf ->Cell(190,10,date('d F Y'),'','','R');
}
$pdf->Cell(140,10,'');
$pdf->Ln(20);
