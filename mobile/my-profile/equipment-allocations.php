...
$query_form = mysqli_query($con, "SELECT * FROM tbl_profile_equipment_allocation WHERE TechId = '$userid'")or die(mysqli_error($con));

$query_list = mysqli_query($con, "SELECT * FROM tbl_profile_equipment_allocation WHERE TechId = '$userid'")or die(mysqli_error($con));
