...
//    ini_set('display_errors', 1);
    ...
    if(isset($_POST['add'])){
        ...
        mysqli_query($con, "INSERT INTO tbl_job_steps (HESId,WorkType) VALUES ('$id','1')")or die(mysqli_error($con));
    }
    ...
    if(isset($_POST['delete'])){
        ...
        foreach($delete as $c){
            ...
            mysqli_query($con, "DELETE FROM tbl_job_steps WHERE Id = '$c'")or die(mysqli_error($con));
        }
    }
    ...
    if(isset($_POST['jobsteps'])){
        ...
        for($i=0;$i<$rows;$i++){
            ...
            mysqli_query($con, "UPDATE tbl_job_steps SET JobSteps = '$jobstep1', PotentialHazard = '$hazard1', CriticalActions = '$actions1' WHERE Id = '$id2'")or die(mysqli_error($con));
        }
    }
    ...
    if(isset($_POST['save']) || isset($_POST['close']) || isset($_POST['preview'])){
        ...
        for($i=0;$i<$rows;$i++){
            ...
            mysqli_query($con, "UPDATE tbl_ppe_relation SET Selected = '$select2', Comments = '$comment2' WHERE Id = '$id2'")or die(mysqli_error($con));
        }
    }
    ...
    $query_Recordset1 = "
            SELECT 
                tbl_sites.Id AS Id_2, 
                tbl_sites.Name AS Name_1, 
                tbl_far_high_risk_classification.Risk, 
                tbl_hes.JobNo, 
                tbl_hes.Date, 
                tbl_hes.ScopeOfWork, 
                tbl_hes_jsa_relation.JSAId, 
                tbl_sites.FirstName, 
                tbl_sites.LastName, 
                tbl_sites.Address, 
                tbl_sites.Suburb, 
            ...
            FROM 
                tbl_hes 
                LEFT JOIN tbl_hes_jsa_relation ON tbl_hes_jsa_relation.JobNo=tbl_hes.JobNo
                LEFT JOIN tbl_companies ON tbl_companies.Id=tbl_hes.CompanyId
                LEFT JOIN tbl_far_high_risk_classification ON tbl_far_high_risk_classification.Id=tbl_hes_jsa_relation.JSAId
    ...
    $query_Recordset2 = "
        SELECT 
            tbl_ppe_list.PPE, 
            tbl_ppe_relation.PPEId, 
            tbl_ppe_relation.Selected, 
            tbl_ppe_relation.Comments, 
            tbl_ppe_relation.HESId, 
            tbl_ppe_relation.Id 
        FROM 
            tbl_ppe_relation LEFT JOIN tbl_ppe_list ON tbl_ppe_list.Id=tbl_ppe_relation.PPEId
        WHERE 
            tbl_ppe_relation.HESId = $KTColParam1_Recordset2  
        AND 
            tbl_ppe_relation.WorkType = '1'
    ";
    ...
    $query_Recordset3 = "SELECT * FROM tbl_job_steps WHERE HESId = $colname_Recordset3 AND JMS = '0' AND WorkType = '1'";
    ...
    $query_Recordset4 = "
        SELECT 
            ...
            tbl_far_high_risk_classification.Risk 
        FROM
            tbl_hes LEFT JOIN tbl_hes_jsa_relation ON tbl_hes_jsa_relation.JobNo=tbl_hes.JobNo
            LEFT JOIN tbl_far_high_risk_classification ON tbl_far_high_risk_classification.Id=tbl_hes_jsa_relation.JSAId
        WHERE 
        tbl_hes.Id = $KTColParam1_Recordset4;
    ";
    ...
    if(isset($_POST['close'])){
            ...
            header('Location: ../../fpdf16/pdf-jsa.php?Id='. $_GET['Id'] .'&Close');

    }

    if(isset($_POST['preview'])){
	
?><script type="text/javascript" language="Javascript">window.open('../../fpdf16/pdf-jsa.php?Id=<?php echo $_GET['Id']; ?>&Preview');</script>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top"><table width="750" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td>
  <form name="form2" method="post" action="jsa.php?Id=<?php echo $_GET['Id']; ?>">
                  ...
                  <td width="50%" align="right" valign="top" class="combo"><table border="0" align="right" cellpadding="2" cellspacing="3" class="combo-grey">
                    ...
                    <tr>
                      ...
                      <td valign="top"><?php do { ?>
                          ...
                          <?php } while ($row_Recordset4 = mysqli_fetch_assoc($Recordset4)); ?></td>
                      </tr>
                    <tr>
