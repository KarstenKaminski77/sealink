...
while($row = mysql_fetch_array($result)){
	...
	mysql_query ("INSERT INTO tbl_jc
	(JobNo, QuoteNo, CompanyId, SiteId, Description1, Unit1, Qty1, Price1, Total3, SubTotal1, VAT1, InvoiceDate, Labour1, Material1, Transport1, InvoiceQ, InvoiceNo, JobId) 
...
header('Location: fpdf16/approved-pdf.php?Id='. $jobid .'');
