...
$query_Recordset3 = "
	...
	INNER JOIN tbl_sites ON tbl_scheduled_maintenance.SiteId = tbl_sites.Id
	    $where
	AND
		tbl_scheduled_maintenance.`Status` = 'In Progress'
	ORDER BY
        ...
        <form name="form2" method="post" action="">
            <div id="list-border">
                <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
                    ...
                    <tr class="cat<?php echo $x; ?>" style="display:none">
                        <td colspan="7" class="td-sub-header">Facility Manager Request</td>
                    </tr>
                    <?php
                    ...
                    ?>
                    <tr class="cat<?php echo $x; ?>" style="display:none">
                        <td colspan="3" class="td-sub-sub-header">Facility Manager Position</td>
                        <td colspan="4" class="td-sub-sub-header">Scope</td>
                    </tr>
                    <?php
                    if($row_request_details['InScope'] == 1){
						
						$scope = 'In Scope';
                    }

                    if($row_request_details['OutScope'] == 1){
						
						$scope = 'Out of Scope';
                    }

                    if($row_request_details['PaScope'] == 1){
						
						$scope = 'PA Out of Scope';
                    }
                    ?>
                    <tr class="cat<?php echo $x; ?>" style="display:none">
                        <td colspan="3" class="td-right"><?php echo $row_request['ManagerPosition']; ?></td>
                        <td colspan="4" class="td-right"><?php echo $scope; ?></td>
                    </tr>
                    <tr class="cat<?php echo $x; ?>" style="display:none">
                        <td colspan="7" class="td-sub-sub-sub-header">Request</td>
                    </tr>
                    <tr class="cat<?php echo $x; ?>" style="display:none">
                        <td colspan="7" class="td-right"><?php echo $row_request_details['Request']; ?></td>
                    </tr>
                    <tr class="cat<?php echo $x; ?>" style="display:none">
                        <td colspan="7" class="td-sub-sub-sub-header">Comments</td>
                    </tr>
                    <tr class="cat<?php echo $x; ?>" style="display:none">
                        <td colspan="7" class="td-right"><?php echo $row_request_details['Comments']; ?></td>
                    </tr>
                    <?php } ?>
                    <?php } ?>
