...
$pdf->Cell(190,10,'Job Method Statement','','','C');
...
$pdf->Cell(63,5,'Job Ste','LRTB','','0','1','');
$pdf->Cell(63,5,'Job Step Hazard','LRTB','','0','1','C');
$pdf->Cell(63,5,'Job Step Control','LRTB','','0','1','');
...
if(isset($_GET['Preview'])){
	...
	$document = 'Seavest MS #'.$id.'.pdf';
	
	$pdf->Output('pdf/'. $document);
	
	mysql_query("UPDATE tbl_hes_documents_relation SET PDF = '$document' WHERE HESId = '$id' AND DocumentId = '3'")or die(mysql_error());
	...
	header('Location: ../health-safety/jms/jms.php?Id='.$_GET['Id']);
}
