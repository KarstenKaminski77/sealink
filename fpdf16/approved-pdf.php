...
$query = mysqli_query($con,"SELECT * FROM tbl_sent_invoices WHERE JobId = '$jobid'") or die(mysqli_error($con));
...
if(isset($_GET['Search'])){
	...
	header('Location: ../invoices/search.php?Search='. $_GET['Id']);

} else {

	header('Location: ../invoice_pending.php');
