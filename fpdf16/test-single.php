...
mysqli_query($con, "UPDATE tbl_jc SET Status = '$status', Days = '$today', SearchDate = '$searchdate' WHERE JobId = '$jobid'") or die(mysqli_error($con));
