...
if (isset($_GET['Id'])) {
	$colname_Recordset9 = addslashes($_GET['Id']);
...
$pdf->Cell(25,4,'R'. number_format($sub_total,2),'','',R);
$pdf->Ln(4);
...
// if($row_Recordset5['VAT'] == 1){
	...
	$pdf->Cell(25,4,'R'. number_format($vat,2),'','',R);
	$pdf->Ln(4);
// }
...
$pdf->Output('pdf/Seavest Invoice ' . $row_Recordset5['InvoiceNo'] . '.pdf');
$pdf->Output();
