...
$oPdf->Cell(190,10,'PROFORMA INVOICE','','','R');
$oPdf->Ln(10);
...
if(isset($_GET['Preview'])){
	...
	$_SESSION['pdf'] = 'Seavest Proforma Invoice #'. $row_invoice_to['InvoiceNo'] .'.pdf';
					
	//$oPdf->Output();
	$oPdf->Output('pdf/'. $_SESSION['pdf']);
		
	header('Location:pdf-scheduled-maintenance.php?Id='. $jobid .'&InvoiceNo='. $row_invoice_to['InvoiceNo']);
}
