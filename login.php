...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Seavest Asset Management - Secure Login</title>
      ...
      <tr>
        <td align="center" valign="middle">
          <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td>
                <div id="banner-error">Either your username or password is incorrect, plwase try again</div>
              </td>
            </tr>
            <?php } ?>
            <tr>
              <td align="center">
                <div class="title-login" id="login-panel">
                  <img src="images/logo.png" width="350" height="60">
