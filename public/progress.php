...
<form action="progress.php" method="post" name="form1" id="form1">
        <table border="0" cellspacing="3" cellpadding="2">
          <tr>
            <td>Search</td>
            <td><select name="menu1" class="tarea" onchange="MM_jumpMenu('parent',this,0)">
                <option value=" ">Select one..</option>
                <option value="progress.php">View All</option>
                <option value="progress.php?num">By Reference No.</option>
                <option value="progress.php?date">By Date</option>
                          </select>            </td>
