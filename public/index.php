...
<table width="880" border="0" cellspacing="10" cellpadding="0">
  <tr>
    ...
    <table width="600" border="0" cellpadding="2" cellspacing="3">
      ...
      <tr>
        <td><div style="padding-left:5px; padding-right:5px"> 
		  <?php echo $row_Recordset1['CustomerFeedBack']; ?>		</div></td>
      </tr>
    </table>
	</div>
