...
$query = mysqli_query($con, "SELECT Address FROM tbl_suppliers WHERE Name = '". $row_Recordset1['Name'] ."'")or die(mysqli_error($con));
...
<title>Order #<?php echo $row_Recordset1['OrderId']; ?></title>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="combo">
                          ...
                          <div style="border-bottom:solid 1px #A6CAF0; width:660px">
                            <table width="660" border="0" cellpadding="0" cellspacing="0" class="combo">
                              <tr>
                                ...
                                <td width="547" class="td-order-form"><div style="padding-left:5px"><?php echo $row_Recordset1['Name'] . $row_Recordset1['Account']; ?></div></td>
                              </tr>
                              <tr>
                                <td valign="top" class="td-order-form-qty"><strong>Address</strong></td>
                                <td class="td-order-form"><div style="padding-left:5px"><?php echo nl2br($row['Address']); ?></div></td>
                              </tr>
                              <tr>
                  ...
                  <table width="660" border="0" cellpadding="0" cellspacing="1" class="combo">
                    ...
                    <tr>
                      ...
                      <td><div id="field-padding" style="padding-left:5px"><?php echo $row_Recordset1['RequestorTel']; ?></div></td>
                      <td valign="bottom">&nbsp;</td>
                      <td><div id="field-padding"><strong>Telephone</strong></div></td>
                      <td><div id="field-padding" style="padding-left:5px"><?php echo $row_Recordset1['IssuerTel']; ?></div></td>
                      <td valign="bottom">&nbsp;</td>
                    </tr>
                    </table>
            </form></td>
