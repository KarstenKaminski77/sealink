        ...
        <form action="PHPExcel/order-numbers.php" method="post" enctype="multipart/form-data" name="form2" style="padding-left:30px">
          <table width="100%" border="0" cellpadding="3" cellspacing="1">
            <tr>
             ...
             <input name="email" type="text" class="tarea-100per" id="email" value="To" 
             onFocus="if (this.value=='To') this.value='';" onBlur="if (this.value.replace(/\s/g,'')=='') this.value='To';" style="width:100%">
             </td>
            </tr>
            <tr>
             ...
             <td colspan="7" align="right" nowrap><input name="test" type="submit" class="btn-blue-generic" id="test" value="Send Test">               <input name="engineer" type="submit" class="btn-red-generic" id="engineer" value="Send to Engineers"></td>
             </tr>
            <tr>
...
?><tr class="<?php echo ($ac_sw1++%2==0)?"odd":"even"; ?>" onMouseOver="this.oldClassName = this.className; this.className='list-over';" onMouseOut="this.className = this.oldClassName;">
              ...
              <input name="jobid[]" type="checkbox" id="jobid[]" value="<?php echo $row_Recordset3['JobId']; ?>" <?php if(in_array($row_Recordset3['JobId'], $_SESSION['jobids'])){ echo 'checked="checked"'; } ?>></td>
              </tr>
